...
void main()
{
    vec2 distortion = (texture(dudvTexture, vec2(textureCoords.x + move,textureCoords.y)).rg * 2.0 - 1.0)*1.5;
    vec2 distortionAgain = (texture(dudvTexture, vec2(move - textureCoords.x,textureCoords.y + move)).rg * 2.0 - 1.0)*1.5;
